...
def test_is_auto_batch_mode():
    ...
    """
    # Test Case 1:
    batch_size_automator = BatchSizeAutomator(2000, 1)
    assert not batch_size_automator.auto_batch_mode
    # Test Case 2:
    batch_size_automator = BatchSizeAutomator(0, 1)
    assert batch_size_automator.auto_batch_mode
    # Test Case 3:
    batch_size_automator = BatchSizeAutomator(2000, 0)
    assert not batch_size_automator.auto_batch_mode
    # Test Case 4:
    batch_size_automator = BatchSizeAutomator(0, 0)
    assert not batch_size_automator.auto_batch_mode
    # Test Case 5:
    batch_size_automator = BatchSizeAutomator(-1000, 1)
    assert batch_size_automator.auto_batch_mode
